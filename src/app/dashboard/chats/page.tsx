...
function ChatsContent() {
  ...
  const canales = ['Todos', 'Instagram', 'WhatsApp', 'Facebook', 'Email']
  ...
  return (
    <div className="fixed inset-x-0 top-16 bottom-0 z-10 flex flex-col bg-white lg:static lg:flex-1 lg:flex-row lg:z-auto lg:overflow-hidden lg:-mx-8 lg:-my-6 lg:border-t lg:border-slate-200">
      {/* PANEL IZQUIERDO */}
          ...
          {conversaciones.length === 0 ? (
            ...
            conversaciones.map(conv => {
              ...
              if (conv.canal === 'instagram') {
                ...
                badgeIcon = <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5"><path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
          ...
          <>
            ...
            <div className="px-4 h-16 flex items-center gap-3 border-b border-slate-200 bg-white shrink-0">
              ...
              <div className="flex items-center gap-3 shrink-0">
                <button onClick={() => setShowMobileContext(true)} className="xl:hidden flex items-center gap-1.5 px-2 py-1.5 -mr-1 rounded-lg text-ink-600 bg-slate-100 hover:bg-slate-200 transition" aria-label="Ver ficha del cliente">
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                  </svg>
                  <span className="text-[11px] font-semibold uppercase tracking-wider">Ficha</span>
                </button>
