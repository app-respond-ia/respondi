  ...
  return (
    <div className={PAGINA}>
      ...
      <Tabla
        ...
        buscar={{ placeholder: 'Buscar por asunto o vendedor…', en: t => `${t.asunto || ''} ${t.vendedores?.nombre || ''}` }}
        pestanas={[
        ...
        onFilaClick={t => router.push(`/superadmin/tickets/${t.id}`)}
        columnas={[
          ...
          { clave: 'vendedor', titulo: 'Vendedor', valor: t => t.vendedores?.nombre || '', render: t => <span className="text-ink-600 whitespace-nowrap">{t.vendedores?.nombre || '—'}</span> },
          { clave: 'categoria', titulo: 'Categoría', valor: t => t.ticket_categorias?.nombre || '', render: t => t.ticket_categorias ? (
            <span className="px-1.5 py-0.5 rounded text-[10px] font-600 border whitespace-nowrap" style={{ backgroundColor: `${t.ticket_categorias.color}15`, color: t.ticket_categorias.color, borderColor: `${t.ticket_categorias.color}30` }}>
