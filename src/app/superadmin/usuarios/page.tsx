  ...
  return (
    <div className="p-6 sm:p-10 max-w-7xl w-full mx-auto pb-20">
      <div className="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="font-display font-700 text-2xl sm:text-3xl text-ink-900">Usuarios Globales</h1>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
        <div className="p-4 border-b border-slate-100 flex flex-col sm:flex-row gap-4">
          ...
          <select
            ...
            className="h-10 px-4 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white focus:outline-none focus:border-brand-500 focus:ring-4 focus:ring-brand-100 transition text-sm"
          >
            <option value="Todos">Todos</option>
            <option value="Clientes">Clientes (Tenants)</option>
                      ...
                      {canWrite && (
                        <div className="flex items-center justify-end gap-2">
                          ...
                          <div className="relative inline-block text-left">
                            ...
                            <div className="hidden group-hover:block absolute right-0 mt-0 w-48 bg-white border border-slate-100 shadow-xl rounded-xl py-1 z-10">
                              {u.rol !== 'super_admin' ? (
                                <>
                                  {u.rol !== 'vendedor' && (
