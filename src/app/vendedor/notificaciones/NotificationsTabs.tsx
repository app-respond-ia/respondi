...
const TIPOS_NOTIFICACIONES = [
  { id: 'conversion', label: 'Conversión de clientes', desc: 'Cuando un cliente pasa de trial a plan de pago.' },
  { id: 'comision_aprobada', label: 'Comisiones aprobadas', desc: 'Cuando una comisión es aprobada.' },
  { id: 'comision_pagada', label: 'Comisiones pagadas', desc: 'Cuando una comisión es marcada como pagada.' },
  { id: 'cliente_riesgo', label: 'Clientes en riesgo', desc: 'Cuando el estado de seguimiento de un cliente pasa a "en riesgo".' },
  { id: 'soporte_respuesta', label: 'Respuestas de soporte', desc: 'Cuando recibes una respuesta a un ticket de soporte.' },
]
