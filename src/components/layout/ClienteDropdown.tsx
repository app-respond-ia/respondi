...
export default function ClienteDropdown({ user }: ClienteDropdownProps) {
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-56 bg-white rounded-2xl shadow-xl border border-slate-100 py-2 z-50 transform origin-top-right transition-all">
          <div className="px-4 py-3 border-b border-slate-100">
            <p className="text-sm font-600 text-ink-900 truncate">{user.nombre}</p>
            <p className="text-xs text-ink-500 truncate">{user.roleName}</p>
          </div>
