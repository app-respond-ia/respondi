  ...
  return (
    <aside className="w-72 bg-ink-900 text-white flex flex-col h-full">
      ...
      <nav className="flex-1 px-3 py-5 space-y-1 overflow-y-auto">
        ...
        <Link href="/app" onClick={onCloseMobile} className={navItemClass('/app')}>
        ...
        <Link href="/app/metricas" onClick={onCloseMobile} className={navItemClass('/app/metricas')}>
        ...
        <Link href="/app/casos" onClick={onCloseMobile} className={navItemClass('/app/casos')}>
        ...
        <Link href="/app/conversaciones" onClick={onCloseMobile} className={navItemClass('/app/conversaciones')}>
        ...
        <Link href="/app/novedades" onClick={onCloseMobile} className={navItemClass('/app/novedades')}>
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/></svg>
          Novedades del día
        </Link>
        <Link href="/app/blacklist" onClick={onCloseMobile} className={navItemClass('/app/blacklist')}>
        ...
        <Link href="/app/perfil-comercio" onClick={onCloseMobile} className={navItemClass('/app/perfil-comercio')}>
        ...
        <Link href="/app/skills" onClick={onCloseMobile} className={navItemClass('/app/skills')}>
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>
          Skills de IA
        </Link>
        <Link href="/app/precios" onClick={onCloseMobile} className={navItemClass('/app/precios')}>
        ...
        <Link href="/app/reglas" onClick={onCloseMobile} className={navItemClass('/app/reglas')}>
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
          Reglas de casos
        </Link>
        <Link href="/app/etiquetas" onClick={onCloseMobile} className={navItemClass('/app/etiquetas')}>
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M7 7h.01M7 3h5a1.99 1.99 0 011.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.99 1.99 0 013 12V7a4 4 0 014-4z"/></svg>
          Etiquetas
        </Link>
        <Link href="/app/canales" onClick={onCloseMobile} className={navItemClass('/app/canales')}>
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.7 9.7 0 01-4-.85L3 20l1.1-3.3A7.6 7.6 0 013 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/></svg>
          Canales
        </Link>
        <Link href="/app/usuarios" onClick={onCloseMobile} className={navItemClass('/app/usuarios')}>
        ...
        <Link href="/app/audit-log" onClick={onCloseMobile} className={navItemClass('/app/audit-log')}>
