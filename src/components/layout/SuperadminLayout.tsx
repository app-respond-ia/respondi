...
export default function SuperadminLayout({
  ...
  const links = [
    ...
    )},
    {
      ...
      subLinks: [
        { href: '/superadmin/usuarios/clientes', seccion: 'usuarios_globales', label: 'Clientes', exact: false },
        { href: '/superadmin/usuarios/vendedores', seccion: 'usuarios_globales', label: 'Vendedores', exact: false },
        { href: '/superadmin/usuarios/superadmins', seccion: 'usuarios_globales', label: 'Superadmins', exact: false }
      ]
    }
  ]
